...
const TweedeGraad: React.FC = () => {
	const navigate = useNavigate();

	const handleStartTest = (jaar: number) => {
		navigate("/persoonlijkheidstest", { state: { graad: 2, jaar: jaar } });
	};
		...
		<>
			...
			<div className="persoonlijkheidstest-intro-container">
				...
				<div className="persoonlijkheidstest-intro-button-group">
					<button onClick={() => handleStartTest(3)}>3de Jaar</button>
					<button onClick={() => handleStartTest(4)}>4de Jaar</button>
				</div>
